...
![RESTful API](https://img.shields.io/badge/RESTful-API-ff69b4)
...
![Zookeeper](https://img.shields.io/badge/Zookeeper-F8DC75?logo=apachezookeeper&logoColor=black)
![HBase](https://img.shields.io/badge/HBase-2E86AB?logo=apache&logoColor=white)
![Qdrant](https://img.shields.io/badge/Qdrant-5F5DFF?logo=qdrant&logoColor=white)
...
![SPSS](https://img.shields.io/badge/SPSS-006699?logo=ibm&logoColor=white)
![Stata](https://img.shields.io/badge/Stata-0033A0?logo=stata&logoColor=white)
...
A lightweight, Java-based distributed system that stores key-value pairs across multiple nodes.  
⛓️ Focus: Replication, fault tolerance, and scalability.

### 🌟 Nara – Chrome Extension
A Chrome extension that boosts user positivity through daily curated tasks and gamified rewards.  
💡 Features: Embedded reminders, feel-good tasks, and motivational quotes  
